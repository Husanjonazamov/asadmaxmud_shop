    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='product.colormodel', verbose_name='Ranglar')),
                ('promotion', models.ManyToManyField(blank=True, null=True, to='product.promotionmodel', verbose_name='Aksiyalar')),
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='product.sizemodel', verbose_name='O‘lchamlar')),
            ],
            options={
